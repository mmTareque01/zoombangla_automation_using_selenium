...
class Home:
    ...
    def search(self, keyword):
        self.driver.find_element(By.XPATH, Locators.search_icon_xpath).send_keys(keyword)
        self.driver.find_element(By.XPATH, Locators.search_box_xpath).send_keys(keyword)
        self.driver.find_element(By.XPATH, Locators.seacrh_button_xpath).click()
